      ...
      <div style={s.doc}>
        ...
        <Section num="5" id="refund-method" title={t('legalRefundMethodTitle')}>
          ...
          <table style={s.table}>
            ...
            <tbody>
              <tr><td style={s.td}>{t('legalRefundMethodCODPay')}</td><td style={s.td}>{t('legalRefundMethodCODMethod')}</td><td style={s.td}>{t('legalRefundMethodCODTime')}</td></tr>
              <tr><td style={s.td}>{t('legalRefundMethodCardPay')}</td><td style={s.td}>{t('legalRefundMethodCardMethod')}</td><td style={s.td}>{t('legalRefundMethodCardTime')}</td></tr>
            </tbody>
          </table>
        ...
        <Section num="8" id="warranty" title={t('legalRefundWarrantyTitle')}>
          <P>{t('legalRefundWarrantyP1')}</P>
          <P>{t('legalRefundWarrantyP2')}</P>
        </Section>

        <Section num="9" id="disputes" title={t('legalRefundDisputesTitle')}>
        ...
        <Section num="10" id="contact" title={t('legalRefundContactTitle')}>
          <P>
