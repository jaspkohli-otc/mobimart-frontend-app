      ...
      <div style={s.doc}>
        ...
        <Section num="5" id="sharing" title={t('legalPrivacySharingTitle')}>
          ...
          <table style={s.table}>
            ...
            <tbody>
              <tr><td style={s.td}><strong>{t('legalPrivacySharingVendorsName')}</strong></td><td style={s.td}>{t('legalPrivacySharingVendorsShare')}</td><td style={s.td}>{t('legalPrivacySharingVendorsWhy')}</td></tr>
              <tr><td style={s.td}><strong>Cloudinary</strong></td><td style={s.td}>{t('legalPrivacySharingCloudinaryShare')}</td><td style={s.td}>{t('legalPrivacySharingCloudinaryWhy')}</td></tr>
              <tr><td style={s.td}><strong>Resend</strong></td><td style={s.td}>{t('legalPrivacySharingResendShare')}</td><td style={s.td}>{t('legalPrivacySharingResendWhy')}</td></tr>
              <tr><td style={s.td}><strong>Tap Payments</strong></td><td style={s.td}>{t('legalPrivacySharingTapShare')}</td><td style={s.td}>{t('legalPrivacySharingTapWhy')}</td></tr>
              <tr><td style={s.td}><strong>{t('legalPrivacySharingCouriersName')}</strong></td><td style={s.td}>{t('legalPrivacySharingCouriersShare')}</td><td style={s.td}>{t('legalPrivacySharingCouriersWhy')}</td></tr>
              <tr><td style={s.td}><strong>{t('legalPrivacySharingGovName')}</strong></td><td style={s.td}>{t('legalPrivacySharingGovShare')}</td><td style={s.td}>{t('legalPrivacySharingGovWhy')}</td></tr>
            </tbody>
          </table>
        ...
        <Section num="8" id="your-rights" title={t('legalPrivacyRightsTitle')}>
          ...
          <P>{t('legalPrivacyRightsContact')} <a href="mailto:support@jasprmarket.com" style={s.link}>support@jasprmarket.com</a>. {t('legalPrivacyRightsResponse')}</P>
        </Section>
        ...
        <Section num="11" id="children" title={t('legalPrivacyChildrenTitle')}>
          <P>{t('legalPrivacyChildrenP1')} <a href="mailto:support@jasprmarket.com" style={s.link}>support@jasprmarket.com</a> {t('legalPrivacyChildrenP2')}</P>
        </Section>
